...
> 北京理工大学硕士研究生  
> 寒武纪深度学习框架研发实习生  
> 方向：AI Infrastructure / 深度学习框架 / AI 编译器 / 大模型训练推理优化

目前主要参与 **PyTorch/MLU 深度学习框架、大模型训练/推理优化、TorchInductor 编译链、高性能计算后端及研发效能基础设施**相关工作。

技术愿景是 **让机器更好的理解和服务人类**，希望持续深入模型、框架、编译器、运行时与硬件之间的完整技术链路。
